...
export const products: Product[] = [
  ...
  },
  {
    ...
    colorOptions: ["Charcoal", "Sea", "Coral", "Snow"],
    conditions: ["Excellent", "Good", "Fair"],
    priceFrom: 249,
    releaseYear: 2023,
    image: "/products/pixel7ablack.png",
    imageWidth: 847,
    imageHeight: 1077,
    imagesByColor: {
      Charcoal: "/products/pixel7ablack.png",
      Sea: "/products/pixel7ablue.png",
      Coral: "/products/pixel7aorange.jpg",
      Snow: "/products/pixel7awhite.jpg",
    },
